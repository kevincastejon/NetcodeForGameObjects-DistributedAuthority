...
using UnityEditor;
namespace Caskev.Samples.NetcodeForGameObjects.DistributedAuthority.DistributedNetworkRigidbody2D.Editor
{
    [CustomEditor(typeof(DistributedNetworkRigidbody2D))]
    public class DistributedNetworkRigidbody2DEditor : UnityEditor.Editor
    {
        ...
        private DistributedNetworkRigidbody2D _script;
        ...
        private void OnEnable()
        {
            ...
            _script = (DistributedNetworkRigidbody2D)target;
        }
